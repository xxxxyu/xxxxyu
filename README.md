...
- **Interested in on-device and physical AI. Previous works focused on system efficiency:**
  ...
  - *Vec-LUT (MobiSys 2026)*: LUT-based mpGeMM kernel for ultra-low-bit LLM inference. [[paper]](https://arxiv.org/abs/2512.06443) [[code]](https://github.com/OpenBitSys/vlut.cpp) [[model]](https://huggingface.co/collections/XXXXyu/vlutcpp)
  ...
  - *Personal LLM Agent (Survey, "Efficiency" Section Lead)*. [[paper]](https://arxiv.org/abs/2401.05459) [[repo]](https://github.com/MobileLLM/Personal_LLM_Agents_Survey)
- **Currently focused on algorithm-system co-design toward generalist embodied agents.**
